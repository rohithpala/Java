        ...
        Thread t1 = new Thread() {
            public void run() {
                synchronized (resource1) {
                    // t1 locks resource1
                    //sleeps for 1000ms
                    //After 1000ms it tries to go into resource2 but it is locked by t2
            ...
            public void run() {
                synchronized (resource2) {
                    ...
                    try {
                        Thread.sleep(1000);
                        //sleeps for 1000ms
                        //After 1000ms it tries to go into resource1 but it is locked by t1
                    } catch (Exception exception) {
                        System.out.println(exception);
                    }
...
//This is one of the solutions to avoid deadlock
/*package Week6;
